        ...
        <Row className="h-100 row-h">
          ...
          <Col xl={6} md={6} xs={6} className="p-0">
            <div className="nav">
             ...
             <span >
             {
                wallet.walletConnect.connected ? walletName : ''

              }
             </span>
              <button className="btn-btn stake-btn" style={{margin: "5px", color: "white"}} onClick={
                  wallet.walletConnect.connected ? disconnectWallet : connect}>{wallet.walletConnect.connected ? 'Disconnect' : 'Connect to wallet'}</button>
              </div>
              {/* menu link */}
              {openMenu && (
                <div className="menu-dropdown">
                  ...
                  >
                    {wallet.walletConnect.web3 ? wallet.walletConnect.address : ''}
                  </a>
